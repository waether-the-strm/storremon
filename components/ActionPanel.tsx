...
export function ActionPanel({
  ...
  return (
    <div className="flex justify-center gap-6 mb-10">
      ...
      <button
        onClick={onEqual}
        className="min-w-[200px] px-10 py-5 bg-gradient-to-br from-primary to-secondary rounded-2xl text-foreground text-base font-medium transition-all duration-200 hover:-translate-y-1 hover:scale-105 shadow-primary"
      >
        <span>= Equal</span>
      </button>
